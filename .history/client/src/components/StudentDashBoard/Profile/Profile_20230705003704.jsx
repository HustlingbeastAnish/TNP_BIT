    ...
    datasets: [
      {
        ...
        data: Object.values(marks), // Use the values of the marks object as data
        backgroundColor: ["violet", "blue", "green", "red", "gray"], // Set background colors for each borderColor: "white",data point
      },
    ],
  };
      ...
      <div>
        ...
        <form className="m-10">
          ...
          <div className="relative z-0 w-full mb-6 group flex flex-col">
            ...
            {flag && (
              <div className="mt-10 mb-10 bg-gray-900 ">
                <Line
                  data={marksData}
                  options={{
                    plugins: {
