...
const Profile = () => {
  ...
  <Select
    ...
    onChange={handleEdit}
  >
    <MenuItem value={"CSE"} style={{ color: updatedStud.branch === "CSE" ? "white" : "inherit" }}>CSE</MenuItem>
    <MenuItem value={"IT"} style={{ color: updatedStud.branch === "IT" ? "white" : "inherit" }}>IT</MenuItem>
    <MenuItem value={"ECE"} style={{ color: updatedStud.branch === "ECE" ? "white" : "inherit" }}>ECE</MenuItem>
    <MenuItem value={"EEE"} style={{ color: updatedStud.branch === "EEE" ? "white" : "inherit" }}>EEE</MenuItem>
    <MenuItem value={"MECH"} style={{ color: updatedStud.branch === "MECH" ? "white" : "inherit" }}>MECH</MenuItem>
    <MenuItem value={"CIVIL"} style={{ color: updatedStud.branch === "CIVIL" ? "white" : "inherit" }}>CIVIL</MenuItem>
  </Select>
</FormControl>
