              ...
              <div className="m-2">
                ...
                <FormControl fullWidth>
                  <Select
                    ...
                    onChange={handleEdit}
                  >
                    <MenuItem value={"CSE"} className="white-menu-item">
                      CSE
                    </MenuItem>
                    <MenuItem value={"IT"} className="white-menu-item">
                      IT
                    </MenuItem>
                    <MenuItem value={"ECE"} className="white-menu-item">
                      ECE
                    </MenuItem>
                    <MenuItem value={"EEE"} className="white-menu-item">
                      EEE
                    </MenuItem>
                    <MenuItem value={"MECH"} className="white-menu-item">
                      MECH
                    </MenuItem>
                    <MenuItem value={"CIVIL"} className="white-menu-item">
                      CIVIL
                    </MenuItem>
                  </Select>
                </FormControl>
