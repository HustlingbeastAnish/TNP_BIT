  ...
  return (
    <div className="bg-gray-900 h-screen">
      ...
      <div>
        ...
        <figure className="flex flex-col items-center justify-center p-2 text-center bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
          <form className="m-10">
