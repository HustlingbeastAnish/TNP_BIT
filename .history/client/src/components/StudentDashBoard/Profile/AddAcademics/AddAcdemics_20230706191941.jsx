        ...
        <div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
          ...
          <FormControl fullWidth>
            <Select
              ...
              label="Branches"
            >
              <MenuItem value={"CSE"}>CBSE</MenuItem>
              <MenuItem value={"IT"}>ICSE</MenuItem>
              <MenuItem value={"ECE"}>STATE</MenuItem>
              <MenuItem value={"EEE"}>CICSE</MenuItem>
              <MenuItem value={"MECH"}>NIOS</MenuItem>
              <MenuItem value={"CIVIL"}>OTHER</MenuItem>
            </Select>
          </FormControl>
