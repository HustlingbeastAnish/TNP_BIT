    ...
    <div className="bg-gray-900 h-screen">
      ...
      <div>
        <div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
          <figure class="flex flex-row items-center justify-around p-2 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
            <div>
              <School />
            </div>
            <div>
              <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                <div className="flex">
                  <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white m-3">
