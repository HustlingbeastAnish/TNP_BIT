        ...
        <div className="border-b border-gray-200 dark:border-gray-700">
          <ul className="flex flex-wrap -mb-px text-base font-medium text-center text-gray-500 dark:text-gray-400">
            <li className="mr-3">
              <a
                href="#"
                className={`inline-flex p-5 border-b-2 text-lg border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group ${
              ...
              >
                <svg
                  aria-hidden="true"
                  className={`w-6 h-6 mr-3 text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300 ${
                    activeMenuItem === "profile"
            ...
            <li className="mr-3">
              <a
                href="#"
                className={`inline-flex p-5 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group ${
            ...
            <li className="mr-3">
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M10 2a5 5 0 100 10A5 5 0 0010 2zm0 2a3 3 0 110 6 3 3 0 010-6zm0 8a7 7 0 006.479-3.905 6 6 0 01-8.957 0A7 7 0 0010 12z"></path>
                </svg>
                Contacts
              </a>
            </li>
