...
const TaskList = () => {
  ...
  const addTask = () => {
    if (curr_task) {
      ...
      const key = `${curr_date} + ${currentTime}`; // Create the key using current date and time
      const updatedTasks = { ...Tasks, [key]: curr_task }; // Add the task with the key to the updatedTasks object
