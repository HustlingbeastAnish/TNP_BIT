          ...
          <div className="relative shadow-md sm:rounded-lg">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr>
                    <th className="w-1/6 md:w-1/12 px-6 py-3 bg-gray-50 text-left text-xs md:text-sm lg:text-sm font-medium text-black uppercase tracking-wider">
                      Status
                    </th>
                    <th className="w-4/6 md:w-5/6 px-6 py-3 bg-gray-50 text-left text-xs md:text-sm lg:text-sm font-medium text-black uppercase tracking-wider">
                      Tasks
                    </th>
                    <th className="w-1/6 md:w-1/12 px-6 py-3 bg-gray-50 text-left text-xs md:text-sm lg:text-sm font-medium text-black uppercase tracking-wider">
                      Action
