    ...
    <div className="h-screen bg-gray-900">
      ...
      <div className="flex flex-col m-2 justify-center items-center">
        ...
        <div className="flex flex-row justify-around items-center m-2">
          <span className="bg-blue-100 m-2 text-blue-800 text-xs font-medium mr-2 px-3 py-1 rounded-full dark:bg-blue-900 dark:text-blue-300">
            {curr_day}
          </span>
          <span className="bg-green-100 text-green-800 text-xs font-medium mr-2 px-3 py-1 rounded-full dark:bg-green-900 dark:text-green-300">
            {curr_date}
          </span>
        </div>
        <div>
