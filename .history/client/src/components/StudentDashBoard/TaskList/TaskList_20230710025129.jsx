  ...
  return (
    <div className="h-screen bg-gray-900">
      ...
      <div className="flex flex-col m-2 justify-center items-center">
        <h2 className="text-4xl md:text-6xl lg:text-6xl font-extrabold text-center">
          My day
        </h2>
        <div className="flex flex-row justify-around items-center m-2">
          <span className="text-base md:text-xl lg:text-xl font-medium mr-2 px-5 py-2 rounded-full dark:text-blue-300">
            {curr_day}
          </span>
          <span className="text-base md:text-xl lg:text-xl font-medium mr-2 px-5 py-2 rounded-full dark:text-green-300">
            {curr_date}
          </span>
        </div>
        <div>
            ...
            <div className="flex flex-row">
              ...
              <div>
                <input
                  ...
                  id="tasks"
                  name="tasks"
                  className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-base md:text-sm lg:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
          ...
          <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
              <div className="mx-auto max-w-screen-sm text-center">
                <p className="mb-4 text-4xl md:text-6xl lg:text-6xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                  Add Events / Tasks
                </p>
                <p className="mb-4 text-base md:text-lg lg:text-lg font-light text-gray-500 dark:text-gray-400">
