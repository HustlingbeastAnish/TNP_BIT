      ...
      <div>
        ...
        >
          <div
            ...
            onClick={openDrawer}
          >
            <button onClick={openDrawer} className="w-12 h-3">
              <span className="absolute w-96 h-1 -translate-x-1/2 bg-gray-300 rounded-lg top-4 left-1/2 dark:bg-gray-600"></span>
            </button>
          </div>
