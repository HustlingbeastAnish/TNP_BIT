...
const Notifications = () => {
  ...
  const fetchJobs = () => {
    axios
      .get(
        `https://api.adzuna.com/v1/api/jobs/in/search/1?&results_per_page=20&content-type=application/json&app_id=24852f12&app_key=c93fe974f8009e5341efb9e2ce97e08f&what=sde&where=bangalore`
      )
      .then((res) => {
        if (res.data.results) {
