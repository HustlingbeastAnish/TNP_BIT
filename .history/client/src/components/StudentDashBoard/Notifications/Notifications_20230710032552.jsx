              ...
              {Arr.map((item, index) => (
                ...
                >
                  <div className="flex items-center mb-2">
                    ...
                    />
                    <div className="text-sm font-medium text-gray-900 dark:text-gray-200 ml-2">
                      {item.title}
                    </div>
                  </div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center mt-2 text-white hover:underline bg-blue-600 py-2 px-4 rounded-md transition-colors duration-300 ease-in-out"
                  >
                    Apply Now
                    <svg
