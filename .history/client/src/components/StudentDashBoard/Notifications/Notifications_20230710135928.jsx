...
const Notifications = () => {
  ...
  const [isMediumScreenOrLess, setIsMediumScreenOrLess] = useState(
    window.innerWidth <= 768 && window.innerWidth > 133
  );
  ...
  const handleResize = () => {
    setIsMediumScreenOrLess(
      window.innerWidth <= 1330 && window.innerWidth >= 133
    );
  };
      ...
      {flag ? (
        <div className="bg-gray-900 h-auto">
          {isMediumScreenOrLess ? (
            <div className="grid md:grid-cols-1 md:grid-cols-2 gap-4 px-4">
              {Arr.map((item, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <a
                    ...
                    className="inline-flex items-center text-white hover:underline bg-blue-600 py-2 px-4 rounded-md mt-4 transition-colors duration-300 ease-in-out"
                  >
                    Explore Now
                    <svg
